<%-- 
    Document   : mantenimiento_facturas
    Created on : 18/05/2022, 06:10:24 AM
    Author     : Steven
--%>
...
<html>
    ...
    <body class="imagenFondo vh-100 overflow-hidden">
            ...
            <div class="row justify-content-center">
                <ul class="nav col-10 bg-secondary justify-content-center rounded-top fw-bolder">
                    ...
                    <li class="nav-item rounded-top active bg-primary">
                        <a class="nav-link text-white" href="mantenimiento_facturas.jsp">Mis Facturas</a>
                    </li>
                </ul>
            </div>
        </header>
        ...
        <%
            ...
            List<Factura_venta> lista;
            String condicion = "id_vendedor = "+vendedor.getId_vendedor();
            lista = lnFventa.ListarRegistros(condicion);
                    ...
                    <div class="col-12">
                        <div class="card p-0 shadow">
                            ...
                            <div class="card-body p-2">
                                <div class="d-flex justify-content-center"><a href="Facturacion.jsp" class="btn btn-primary"><i class="fas fa-plus" style="color: white"></i></a></div>
                                ...
                                <table class="table" id="tblClientesLista">
                                    ...
                                    <tbody>
                                        <%for (Factura_venta registro : lista) {
                                        %>

                                        <tr>
                                            <%int codigo = registro.getId_venta();%>
                                            <td><%=codigo%></td>
                                            ...
                                            <td><%=registro.getImporte()%></td>
                                            <td>
                                                <a href="Facturacion.jsp?nFactura=<%=codigo%>"><i class="fas fa-user-edit"></i></a>
                                                <a href="#" onclick="confirmarEliminacion('EliminarFactura?idFactura=','<%=codigo%>')"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>  
                                        <%}%>
                                    </tbody>
        ...
        <script>
            ...
            function confirmarEliminacion(texto1, texto2){
                ...
                let confirmacion = confirm("Seguro que desea eliminar esta Factura?");
                if(confirmacion){
