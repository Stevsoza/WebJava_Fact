...
public class EliminarFactura extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        fVenta.setId_venta(Integer.parseInt(request.getParameter("idFactura")));
        
        LnFacturaVenta lnFventa = new LnFacturaVenta();
        try{
            resultado = lnFventa.Eliminar(fVenta);
            mensaje = lnFventa.getMensaje();
            
            response.sendRedirect("mantenimiento_facturas.jsp?msg="+mensaje);
        }catch(Exception ex){
