    ...
    <body class="imagenFondo vh-100 overflow-hidden">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" onclick="confirmarEliminacion('EliminarCliente?idCliente=','<%=codigo%>')"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>  
                                        <%}%>
                                    </tbody>
        ...
        <script>
            ...
            function confirmarEliminacion(texto1, texto2){
                ...
                let confirmacion = confirm("Seguro que desea eliminar este cliente?");
                if(confirmacion){
